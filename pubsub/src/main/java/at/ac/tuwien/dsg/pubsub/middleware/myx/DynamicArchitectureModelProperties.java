...
public interface DynamicArchitectureModelProperties {
    ...
    public static final String PUBLISHER_ENDPOINT_VIRTUAL_EXTERNAL_INTERFACE_NAME = "VirtualExternalPublisherEndpoint";
    ...
    public static final String SUBSCRIBER_ENDPOINT_VIRTUAL_EXTERNAL_INTERFACE_NAME = "VirtualExterbalSubscriberEndpoint";
