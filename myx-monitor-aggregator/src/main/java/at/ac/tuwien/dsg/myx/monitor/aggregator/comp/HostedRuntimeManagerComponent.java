...
import at.ac.tuwien.dsg.myx.monitor.aggregator.hosted.HostedArchStructureRuntimeManager;
...
public class HostedRuntimeManagerComponent extends AbstractMyxSimpleBrick {
    ...
    public void init() {
        ...
        hostedRuntimeManager = new HostedArchStructureRuntimeManager(modelRoot);
    }
